...
fn text_sm_bg(text_to_convert: String, line_size: i128) -> String {
    ...
    for text_character in text_to_convert.chars() {
        ...
        match text_character {
            ...
            'a' | 'A' => {
                text_converted_line1 = format!("{} {}{}", text_converted_line1, "    A    ", text_converted_return);
                text_converted_line2 = format!("{} {}{}", text_converted_line2, "   A A   ", text_converted_return);
                text_converted_line3 = format!("{} {}{}", text_converted_line3, "  A   A  ", text_converted_return);
                text_converted_line4 = format!("{} {}{}", text_converted_line4, " AAAAAAA ", text_converted_return);
                text_converted_line5 = format!("{} {}{}", text_converted_line5, "A       A", text_converted_return);
                    }
            'b' | 'B' => {
